...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-68 flex-none flex-col gap-5 border-r border-border bg-surface p-4 transition-transform duration-200 md:static md:z-auto md:w-63 md:translate-x-0 ${
